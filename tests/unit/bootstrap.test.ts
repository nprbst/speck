...
import { mkdtempSync, rmSync, existsSync, mkdirSync, writeFileSync, readFileSync, chmodSync, symlinkSync, lstatSync, readlinkSync } from "node:fs";
...
describe("Bootstrap - Install Instructions", () => {
  ...
  test("includes WSL-specific notes when applicable", () => {
    const wslNote = "After installing, you may need to restart your terminal or run: source ~/.bashrc";
