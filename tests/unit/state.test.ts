...
describe("state management", () => {
  ...
  describe("saveState / loadState", () => {
    it("should save state to file", async () => {
      const { createSession, saveState } = await import("../../plugins/speck-reviewer/cli/src/state");
    ...
    it("should load state from file", async () => {
      const { createSession, saveState, loadState } = await import("../../plugins/speck-reviewer/cli/src/state");
  ...
  describe("clearState", () => {
    it("should remove state file", async () => {
      const { createSession, saveState, clearState } = await import("../../plugins/speck-reviewer/cli/src/state");
  ...
  describe("cluster navigation", () => {
    it("should find next pending cluster", async () => {
      const { createSession, getNextCluster } = await import("../../plugins/speck-reviewer/cli/src/state");
      ...
      session.clusters = [
        { id: "cluster-1", name: "A", description: "", files: [], priority: 1, dependsOn: [], status: "reviewed" },
        { id: "cluster-2", name: "B", description: "", files: [], priority: 2, dependsOn: [], status: "pending" },
        { id: "cluster-3", name: "C", description: "", files: [], priority: 3, dependsOn: [], status: "pending" },
      ];
    ...
    it("should find previous cluster", async () => {
      const { createSession, getPreviousCluster } = await import("../../plugins/speck-reviewer/cli/src/state");
      ...
      session.clusters = [
        { id: "cluster-1", name: "A", description: "", files: [], priority: 1, dependsOn: [], status: "reviewed" },
        { id: "cluster-2", name: "B", description: "", files: [], priority: 2, dependsOn: [], status: "in_progress" },
        { id: "cluster-3", name: "C", description: "", files: [], priority: 3, dependsOn: [], status: "pending" },
      ];
    ...
    it("should find cluster by name", async () => {
      const { createSession, getClusterByName } = await import("../../plugins/speck-reviewer/cli/src/state");
      ...
      session.clusters = [
        { id: "cluster-1", name: "Data Models", description: "", files: [], priority: 1, dependsOn: [], status: "pending" },
        { id: "cluster-2", name: "API Routes", description: "", files: [], priority: 2, dependsOn: [], status: "pending" },
      ];
