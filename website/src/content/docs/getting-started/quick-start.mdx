...
import quickstartDemo from '@/assets/demos/quickstart-workflow.cast?url';
import quickstartFallback from '@/assets/demos/fallbacks/quickstart-workflow.md?raw';
...
Watch this complete workflow demo, or follow the step-by-step instructions below:

<AsciinemaPlayer
  src={quickstartDemo}
  title="Quick Start: Complete Speck Workflow"
  loop={false}
  autoPlay={false}
  speed={1.0}
  fallbackText={quickstartFallback}
/>
