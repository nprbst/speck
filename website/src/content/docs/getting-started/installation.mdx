...
import installDemo from '@/assets/demos/installation-workflow.cast?url';
import installFallback from '@/assets/demos/fallbacks/installation-workflow.md?raw';
...
Watch this quick demo of the complete installation workflow, or follow the step-by-step instructions below:

<AsciinemaPlayer
  src={installDemo}
  title="Speck Installation Workflow"
  loop={false}
  autoPlay={false}
  speed={1.0}
  fallbackText={installFallback}
/>
