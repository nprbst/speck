/**
 * @speck/common/github/types - GitHub API type definitions
 *
 * Common types for GitHub REST API and GraphQL operations.
 */
...
// =============================================================================
// PR Types (used by speck-reviewer and potentially other plugins)
// =============================================================================
